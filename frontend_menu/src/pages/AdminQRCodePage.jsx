    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        <Card className="border-green-200 bg-green-50/60">
          ...
          <CardContent>
            <div className="rounded-xl border border-[#e6e0d4] bg-[#faf7f0] p-4 flex gap-3">
              <Info className="w-6 h-6 text-[#5b7a6b] shrink-0" />
              <p className="text-sm text-[#2a3329]">Il QR apre il menu clienti sullo stesso sito che stai usando. Prima di stamparlo, verifica l'indirizzo con «Apri menu clienti».</p>
            </div>
          </CardContent>
        </Card>
