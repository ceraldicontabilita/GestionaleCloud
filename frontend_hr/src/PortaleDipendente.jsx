...
const api = axios.create({ baseURL: import.meta.env.VITE_API_URL || "/hr/api", timeout: 15000 });
  ...
  return (
    <>
      <div className="card"><h3>Turni settimana</h3>
        ...
        <button className="btn" style={{marginTop:10}} onClick={()=>{window.location.href="/hr/dipendenti/turni";}}>
  ...
  return (
    <div className="pt-root">
      ...
      <div className="pt-head">
        ...
        {role==="admin" && <button className="logout" style={{right:96,background:"#3f5a4e",color:"#fff"}} onClick={()=>{window.location.href="/hr/dipendenti";}}><Settings size={13}/> Gestione</button>}
        {role==="responsabile_turni" && <button className="logout" style={{right:96,background:"#3f5a4e",color:"#fff"}} onClick={()=>{window.location.href="/hr/dipendenti/turni";}}><Grid3X3 size={13}/> Turni azienda</button>}
