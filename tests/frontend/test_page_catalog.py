...
def test_catalogo_contiene_esattamente_le_67_schermate_numerate():
    assert [page["id"] for page in PAGES] == list(range(1, 68))
    assert len({page["path"] for page in PAGES}) == 67
