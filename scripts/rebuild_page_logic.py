...
PAGE_LOGIC: dict[int, dict[str, Any]] = {
    ...
    69: page(
        ["menu_categories/menu_subcategories/menu_products", "menu_allergens", "menu_sale (campi pubblici)", "immagini in gestionale.blobs"],
        ["menu_orders (source=cliente, paid=false)", "carrello e ultimo ordine nel telefono del cliente"],
        [
            "Aprire /menu dal QR senza sessione: il middleware lascia passare solo /api/menu/pubblico.",
            "Navigare categoria -> sottocategoria -> prodotti, filtrare per allergeni, cambiare lingua IT/EN.",
            "Comporre il carrello e inviare l'ordine con tavolo, sala, coperti e metodo di pagamento; il backend applica coperto e blocco contanti della sala.",
            "Seguire lo stato del proprio ordine per id.",
        ],
        ["Nessuna."],
        ["Prodotto ↔ sottocategoria ↔ categoria; ordine ↔ sala; immagine ↔ blob a contenuto."],
        ["Nessun dato riservato in /api/menu/pubblico (la password WiFi resta nell'area gestione); ordine mai 'gia' pagato' dal QR; massimo 60 righe."],
        ["Ordine dal QR visibile in Ordini/Cassa entro 5 secondi con totale = prodotti + coperto; contanti rifiutati se la sala li blocca."],
    ),
    70: page(
        ["menu_orders"],
        ["menu_orders.status / updated_at"],
        ["Vedere gli ordini per stato, avanzarli (nuovo -> in corso -> pronto -> completato) o annullarli; aggiornamento automatico ogni 5 secondi."],
        ["Polling ogni 5 secondi."],
        ["Ordine ↔ sala ↔ prodotti."],
        ["Qualunque sessione valida (anche portale dipendenti); sola lettura non scrive."],
        ["Avanzamento riflesso nel monitor cucina e nello stato pubblico dell'ordine."],
    ),
    71: page(
        ["catalogo pubblico del menu", "menu_sale", "menu_orders non pagati"],
        ["menu_orders (source=cassa, paid=true, created_by)", "menu_orders.paid / payment_method"],
        ["Cercare i prodotti, comporre l'ordine al banco con sala e coperti, registrarlo come pagato in contanti o POS; incassare gli ordini dal QR ancora da pagare."],
        ["Coda 'da incassare' aggiornata ogni 8 secondi."],
        ["Ordine ↔ operatore che lo ha registrato ↔ sala."],
        ["Un ordine di cassa nasce sempre con source=cassa; chi lo registra e' tracciato nel documento."],
        ["Ordine di cassa registrato con totale coerente e pagato; ordine QR incassato sparisce dalla coda."],
    ),
    72: page(
        ["menu_orders attivi (nuovo, in corso)"],
        ["menu_orders.status"],
        ["Schermo cucina: ticket con minuti trascorsi (rosso oltre 10), 'Inizia preparazione' e 'Pronto'."],
        ["Polling ogni 5 secondi; orologio ogni 30."],
        ["Ordine ↔ tavolo ↔ note."],
        ["Stesso perimetro di Ordini."],
        ["Un ordine segnato pronto lascia il monitor ed entra nella colonna Pronti."],
    ),
    73: page(
        ["magazzino_bar_prodotti (collezione di Lotti, condivisa)", "menu_warehouse_movements"],
        ["magazzino_bar_prodotti (nome/unita/stock/soglia/categoria/fornitore)", "menu_warehouse_movements (carico/scarico/rettifica con operatore)"],
        ["Elenco articoli con ricerca e avviso sotto soglia; nuovo articolo; carico/scarico con nota; eliminazione (anche per Lotti)."],
        ["Nessuna."],
        ["Articolo ↔ movimenti ↔ operatore."],
        ["Bevande e alcolici a cartone/bottiglia, mai a kg/litro; un solo magazzino per Menu e Lotti."],
        ["Un carico aggiorna la giacenza e lascia un movimento con quantita', risultato e operatore."],
    ),
    74: page(
        ["menu_sale"],
        ["menu_sale (nome, ordini_abilitati, coperto, blocco contanti QR)"],
        ["Creare, modificare, eliminare le sale; abilitare gli ordini; impostare coperto a persona e blocco contanti dal QR."],
        ["Nessuna."],
        ["Sala ↔ ordini ↔ carrello pubblico."],
        ["Modifiche solo admin/operatore; il resto dello staff vede l'elenco."],
        ["Sala con coperto attivo aggiunge l'importo agli ordini; sala con contanti bloccati rifiuta gli ordini QR in contanti."],
    ),
    75: page(
        ["catalogo menu", "menu_immagini + gestionale.blobs", "menu_qrcode_config", "sorgente Supabase del vecchio menu (solo migrazione)"],
        ["categorie/sottocategorie/prodotti", "immagini deduplicate per contenuto", "configurazione QR/WiFi", "ripristino collezioni da backup JSON"],
        [
            "Gestire il catalogo: categorie, sottocategorie (eliminazione a cascata), prodotti con allergeni, prezzo, descrizioni IT/EN e immagine scelta tra quelle caricate.",
            "Caricare immagini (JPG/PNG/WEBP/GIF fino a 10 MB): un file identico non viene duplicato.",
            "Configurare l'indirizzo del menu e il WiFi, scaricare i QR in SVG.",
            "Scaricare il backup JSON completo; l'admin puo' ripristinarlo e importare i dati dal vecchio Supabase (prova a secco, poi reale) con confronto dei conteggi.",
        ],
        ["Migrazione in background con stato interrogabile."],
        ["Prodotto ↔ sottocategoria ↔ categoria ↔ immagine; backup ↔ blob immagini."],
        ["Solo admin/operatore; ripristino e migrazione solo admin; credenziali della sorgente solo nelle env di Render."],
        ["Prodotto salvato visibile subito nel menu pubblico; backup esportato e ripristinato senza perdita di immagini; migrazione con conteggi coincidenti."],
    ),
    76: page(
        ["stesse fonti di Ordini, Cassa, Cucina, Magazzino bar"],
        ["stesse scritture, con operatore = dipendente del portale"],
        ["Entrare da /portale con il PIN personale, aprire /menu-banco: ordini, cassa, cucina e magazzino senza il layout del gestionale; 'Esci' chiude la sessione del portale."],
        ["Nessuna."],
        ["Dipendente del portale ↔ ordini registrati ↔ movimenti di magazzino."],
        ["Token del portale valido solo su /api/hr e /api/menu/staff (+ pubblico): mai gestione del menu, mai dati contabili."],
        ["Un dipendente con token del portale registra un ordine di cassa e un carico; un tentativo su /api/menu/admin risponde 403."],
    ),
    68: page(
