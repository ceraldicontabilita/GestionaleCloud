...
PAGE_LOGIC: dict[int, dict[str, Any]] = {
    ...
    8: page(
        ["Prima Nota Cassa", "Prima Nota Banca", "SumUp/POS", "finanziamenti soci", "fatture e movimenti bancari"],
        ["scritture tramite writer unico", "trasferimenti Cassa-Banca", "relazioni e correzioni tracciate"],
        [
            ...
            "Le vendite POS generano crediti attesi; accredito provider, commissione e movimento banca restano fatti separati ma collegati.",
    ...
    40: page(
        ["corrispettivi RT", "chiusure POS", "transazioni/accrediti SumUp", "movimenti banca", "commissioni"],
        ["casi di differenza e relazioni confermate", "nessuna nuova vendita"],
        [
            "Confrontare per giorno e terminale: vendite carta RT, chiusura terminale, credito provider atteso e accredito banca.",
            "Mostrare lordo, commissioni, netto, date di competenza/accredito e differenza con elenco operazioni.",
            "Riconciliare accrediti uno-a-uno o molti-a-uno quando il provider lo documenta, conservando tutti gli ID.",
        ],
