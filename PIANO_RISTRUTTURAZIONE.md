...
| 2026-09-22 | RST-0508AL-FOTO-RICETTE-DRIVE | 🟡 | Archivio originale `Ricettario_GestionaleCloud_368_immagini.zip` caricato e verificato nell'account `ceraldicontabilita@gmail.com`, cartella Drive `Ricettario_GestionaleCloud_Immagini`; 856.572.274 byte, SHA-256 locale `57496EC4C7C3BBFE8AEBAA4DDF62B28CDF211F37FA6649911911AA1596BF06B3`. Sottocartella `immagini_ricette_per_id`: 368 PNG, 368 nomi-ID univoci, nessun mancante o extra. Confronto esatto con Supabase: 365 ricette operative, 364 ID presenti nel pacchetto, quattro immagini solo archivio per ricette eliminate, `Cornetto Classico` unico record vivo non incluso. Stato precedente: 204 documenti `foto_files`, 139 ricette con riferimento foto; cestino 402 record, 192 con foto e 72 foto distinte. PR #660 riscrive upload, lettura e copia Menu con byte canonici su Drive e soli metadati in Supabase; la cartella e' risolta dal registro `drive_folder_registry` persistito in Supabase con provenienza verificata, senza configurazione manuale Render. Nessuna foto Supabase eliminata prima di migrare anche i riferimenti recuperabili del cestino. CI PR 35767461551 e E2E/audit 35767461600 verdi; merge, cut-over, conteggi e health ancora da verificare. |
