...
- Ultima tranche conclusa: [PR #650](https://github.com/ceraldicontabilita/GestionaleCloud/pull/650), rimozione del seed automatico dei panini per nome.
- Codice pubblicato e verificato: **`1447880a002996e87e6d57159c15419f2ccd104a`**.
- Prova di produzione: [workflow 35687998889](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35687998889), E2E isolato, audit layout e smoke verdi; `/lotti/api/health` ha restituito il commit di merge esatto; [CI 35687998875](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35687998875) verde. Nessun record operativo già persistito è stato cancellato.
...
| 2026-09-22 | RST-0508AI-RICETTE-STORICHE | 🟡 | Rimossi dal codice il seed delle ricette solo-nome all'avvio, le liste e quantità dettate statiche, l'import e la ricerca web delle foto per nome senza chiamanti vivi. Nessun record o immagine già salvati vengono eliminati; restano caricamento e modifica della ricetta operativa per ID. Test di due riavvii esteso anche a Spritz eliminato: 15 test backend mirati verdi. PR/CI/E2E/merge/health ancora da verificare. |
...
**Rilascio verificato:** RST-0508AH della PR #650 è pubblicato con `1447880a002996e87e6d57159c15419f2ccd104a`, confermato da `/lotti/api/health`. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
