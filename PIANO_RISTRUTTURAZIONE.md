...
- Ultima tranche conclusa: [PR #651](https://github.com/ceraldicontabilita/GestionaleCloud/pull/651), rimozione del seed storico delle ricette e dell'import web delle foto per nome.
- Codice pubblicato e verificato: **`12d5a6c768761cbdcf60b091d11b6a6632952a85`**.
- Prova di produzione: [workflow 35689440830](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35689440830), E2E isolato, audit layout e smoke verdi; `/lotti/api/health` sui due domini ha restituito il commit di merge esatto; [CI 35689440865](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35689440865) verde. Nessun record o immagine già persistiti sono stati cancellati.
