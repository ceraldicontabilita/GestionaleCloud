...
- Ultima tranche conclusa: [PR #607](https://github.com/ceraldicontabilita/GestionaleCloud/pull/607), unico login PIN tablet Lotti con ID dipendente HR.
- Codice pubblicato e verificato: **`9fb39865d025aff4e59e9ce5727fcdbc8e1f4e68`**.
- Prova di produzione: [workflow 35618108690](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35618108690), tutti i job superati, inclusa verifica commit servito e smoke.
...
| 2026-09-21 | RST-0403B-PERSONALE-TABLET | 🟡 | Elenco e modifica dei soli attributi HACCP del personale tablet usano `dipendente_id` HR nell'API e nella UI; ID della proiezione resta interno per preservare lo storico. Le righe non collegate a HR restano visibili senza identità attribuita; verifica CI/E2E/Produzione in corso |
...
**Rilascio verificato:** RST-0403A della PR #607 è pubblicato e accessibile live con `9fb39865`; le PR #603-#606 e le precedenti PR #599-#602 restano pubblicate. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
