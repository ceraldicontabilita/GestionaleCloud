...
| 2026-09-22 | RST-0508P-TASK-SCADENZA | 🟡 | Audit del flusso «Usa oggi»: il pulsante crea task di testo senza ID lotto e a ogni clic li duplica; lo scheduler seleziona anche lotti già scaduti perché controlla solo la soglia superiore. Riscrivere l'emissione task scadenza con ID lotto reale, una sola emissione giornaliera condivisa fra UI e scheduler e scadenza verificata. Sostituire il DELETE del task con annullamento motivato che conserva lo storico. Test locali verdi; CI/rilascio da verificare |
...
**Rilascio verificato:** RST-0508O della PR #631 è pubblicato e accessibile live con `d5b4f3bc`; le PR #603-#630 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
