...
- Ultima tranche conclusa: [PR #653](https://github.com/ceraldicontabilita/GestionaleCloud/pull/653), interfaccia Prodotti Galatea accessibile e utilizzabile anche su mobile.
- Codice pubblicato e verificato: **`84eee76d751fdd46f4fc6fb5c6532587bb3ba5b0`**.
- Prova di produzione: [CI 35692391536](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35692391536) e [Produzione/E2E 35692391527](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35692391527) verdi; `/lotti/api/health` su `gestionalecloud.onrender.com` ha restituito il commit di merge esatto. La revisione UX delle altre pagine resta aperta in RST-0906.
...
| 2026-09-22 | RST-0302A-RITIRO-ARCHIVIO-SHEETS | 🟡 | Rimuovere le dichiarazioni residue di Sheets come archivio attuale da configurazione, catalogo pagine, knowledge base, documentazione e audit; eliminare la migrazione amministrativa storica non più eseguibile. Il chiamante vivo dell'archivio email/PartenoPay usa la radice documentale Drive canonica senza fallback al vecchio registro Sheets. I documenti originali restano su Drive e i dati applicativi su Supabase: non si eliminano fogli Excel, riferimenti a bilanci o documenti esterni. Test mirati e pubblicazione ancora da completare. |
