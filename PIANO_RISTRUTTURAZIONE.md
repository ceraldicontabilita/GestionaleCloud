...
- Ultima tranche conclusa: [PR #615](https://github.com/ceraldicontabilita/GestionaleCloud/pull/615), sessione tablet riutilizzata tra reparti.
- Codice pubblicato e verificato: **`bd72b54147fe75255ad38df1476accd174a5a845`**.
- Prova di produzione: [workflow 35628146336](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35628146336), tutti i job superati, inclusa verifica commit servito e smoke.
...
| 2026-09-21 | RST-0507A-ESCLUSIONE-RICETTE | 🟡 | In lavorazione: il comando delle card e del ricettario diventa Escludi; il record e i suoi dati restano in Ricette, con filtro Escluse e ripristino. Test, CI/E2E e pubblicazione da verificare |
...
**Rilascio verificato:** RST-0403H della PR #615 è pubblicato e accessibile live con `bd72b541`; le PR #603-#614 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
