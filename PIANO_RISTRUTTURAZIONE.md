...
| 2026-09-21 | RST-0508G-GELATO-RECUPERATO | 🟡 | Formalizzare il calcolo 5 kg obiettivo − 1,5 kg rientrati = 3,5 kg nuovi, scalare le dosi sulla sola produzione nuova e impedire che recuperi superiori al totale o alla giacenza creino lotti incoerenti. I dati live gelateria hanno attualmente zero invenduti e zero produzioni: verifica comportamentale con test, non simulare movimenti reali. CI, E2E e pubblicazione da verificare |
...
**Rilascio verificato:** RST-0508F della PR #622 è pubblicato e accessibile live con `8ac36a10`; le PR #603-#621 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
