...
- Ultima tranche conclusa: [PR #612](https://github.com/ceraldicontabilita/GestionaleCloud/pull/612), firma manuale delle temperature con ID dipendente HR.
- Codice pubblicato e verificato: **`946056d864fa32ebd6074e48a3d05fcb80b19608`**.
- Prova di produzione: [workflow 35624554446](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35624554446), tutti i job superati, inclusa verifica commit servito e smoke.
...
| 2026-09-21 | RST-0403H-SESSIONE-TABLET | 🟡 | Login Lotti e tablet condividono la sessione del medesimo `dipendente_id`; la navigazione fra reparti non richiede il PIN finché il token è presente. L'ulteriore scadenza tablet di due ore è rimossa; conferma recente delle azioni resta distinta. CI/E2E/Produzione da verificare |
...
**Rilascio verificato:** RST-0111 della PR #614 è pubblicato e accessibile live con `f567cd2a`; le PR #603-#613 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
