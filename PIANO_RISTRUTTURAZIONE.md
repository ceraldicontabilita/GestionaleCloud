...
| 2026-09-21 | RST-0508N-LOTTI-SCADUTI | 🟡 | Audit web reale: «Cosa usare oggi» mostra un lotto scaduto con il pulsante «Usa oggi». Separare i lotti utilizzabili, scaduti e con data non verificabile; sui lotti scaduti mostrare solo dettaglio/smaltimento. Test e pubblicazione da verificare |
...
**Rilascio verificato:** RST-0508M della PR #629 è pubblicato e accessibile live con `9e1d9b30`; le PR #603-#628 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
