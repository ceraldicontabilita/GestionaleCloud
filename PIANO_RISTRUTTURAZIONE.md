...
| 2026-09-21 | RST-0508H-SESSIONE-MAGAZZINO | 🟡 | Rimuovere il secondo PIN ogni 10 minuti per prelievo e conferma della lavagna: usare l'ID dipendente della sessione tablet già autenticata, eliminare il timer legacy e mantenere il rifiuto delle azioni senza sessione. Test del prelievo, CI, E2E e pubblicazione da verificare. La registrazione serale degli invenduti è un flusso distinto da verificare nella tranche seguente |
...
**Rilascio verificato:** RST-0508G della PR #623 è pubblicato e accessibile live con `c2669562`; le PR #603-#622 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
