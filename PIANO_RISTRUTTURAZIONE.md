...
| 2026-09-22 | RST-0508W-ELIMINAZIONE-RICETTE | 🟡 | Audit reale prima delle immagini: 587 ricette operative, zero gruppi duplicati per nome canonico e zero duplicati `Nome / Nome (Base)` eliminabili. Individuata per verifica operativa la coppia equivalente «Babà Napoletano al Rum» / «Babà al rhum»: nessuna variante, produzione o lotto riferiti agli ID; resta «Babà al Rum» con procedimento e l'altra scheda sarà nel cestino recuperabile. In corso: comando amministrativo «Elimina ricetta» sulle card, con copia recuperabile in cestino e nessuna variante orfana |
...
**Rilascio verificato:** RST-0508V della PR #638 è pubblicato e accessibile live con `7b6ec7b0`; le PR #603-#637 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
