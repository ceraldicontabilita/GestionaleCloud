...
| RST-0004 | 🟡 | Contratto route React ↔ catalogo implementato: `route_kind` distingue pagina/tab/dettaglio, i redirect React sono dichiarati nel catalogo e verificati automaticamente, i dettagli dinamici richiedono route compatibile ed `e2e_path` concreto. Attende CI/E2E e rilascio |
