...
| 2026-09-22 | RST-0508Q-USCITE-LOTTO | 🟡 | Audit dei flussi vivi Recupera/Manda al banco: gli endpoint controllavano il richiamo ma non la scadenza; Recupera usava la chiave di idempotenza `banco_` e poteva riservarla prima della convalida. Servizio comune di prelievo con scadenza verificata, scarico condizionale e retry separato per banco/recupero; modale migrato con ID operazione stabile e ID dipendente della sessione. 40 test backend e build Lotti locali verdi; CI/rilascio da verificare |
