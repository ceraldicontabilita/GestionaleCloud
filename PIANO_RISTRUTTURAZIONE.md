...
| 2026-09-21 | RST-0508D-RICETTE-CANONICHE | 🟡 | La card Ricette apre direttamente `#ricette`, senza seconda pagina tablet; la sessione dipendente permette la consultazione, le modifiche restano riservate al titolare. Unico componente del moltiplicatore nelle schede. Spostare inoltre Aranciata nel catalogo acquistati con foto e origine Excel; reimport senza ricreare la ricetta. CI, pubblicazione e migrazione reale da verificare |
...
**Rilascio verificato:** RST-0508C della PR #619 è pubblicato e accessibile live con `221bd462`; le PR #603-#618 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
