...
- Ultima tranche conclusa: [PR #645](https://github.com/ceraldicontabilita/GestionaleCloud/pull/645), ripristino delle ricette operative dal cestino con ID invariato.
- Codice pubblicato e verificato: **`797cd910ae874b4543e2cfc19ab1f74f0adc9014`**.
- Prova di produzione: [workflow 35683007881](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35683007881), E2E isolato, audit layout e smoke; `/lotti/api/health` ha restituito il commit di merge esatto; [CI 35683007877](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35683007877) verde.
...
| 2026-09-22 | RST-0508AF-GALATEA-ACQUISTI | 🟡 | Difetto riprodotto: Gelati/Prodotti Galatea è un segnaposto statico. Fattura reale ERP `1785230041203`, n. `001852/2` del 14/05/2026, cedente GELINOVA GROUP SRL P.IVA `03762010266`, hash file `1c404b129195…`, Drive `1vNUuC_IvTOH8kXNV69RHJI41ZGDw4nxO`; copia Lotti `0966541d-e8ff-47f8-9d04-f6650a600abc` con 22 righe prodotto. La 23ª riga ERP è descrittiva, non un articolo. In questa tranche il pannello legge le righe Lotti per identità fiscale esatta, mostra codice/quantità/prezzo/provenienza, senza inventare allergeni, giacenza o categorie; corretti commenti che chiamavano Mongo il persistente Supabase. Test locali verdi; PR, CI/E2E, merge e health ancora da verificare. L'adattatore compatibile Mongo in memoria rimane debito strutturale distinto. |
