...
| 2026-09-22 | RST-0508AT-MIGRAZIONE-FOTO-NAPOLETANE | 🟡 | [PR #671](https://github.com/ceraldicontabilita/GestionaleCloud/pull/671), merge `a1d6a8ab9982c3a6ef31bb8a348b9da99e9d4f17`: worker una-tantum per i 20 UUID esatti, riprendibile e completo solo dopo hash e sync Menu. CI `35788029525` e Produzione/E2E `35788029580` verdi; health ha confermato il merge esatto. La prova dati ha però riprodotto 20/20 errori Google Drive `storageQuotaExceeded`: questa tranche non è dichiarata completata e ha portato alla riscrittura canonica #672. |
