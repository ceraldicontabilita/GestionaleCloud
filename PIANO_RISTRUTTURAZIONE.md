...
- Ultima tranche conclusa: [PR #648](https://github.com/ceraldicontabilita/GestionaleCloud/pull/648), Prodotti Galatea dalle righe fattura verificate anziché dal segnaposto.
- Codice pubblicato e verificato: **`bd3eff28bc0412e84071f2390b60e61032bd4832`**.
- Prova di produzione: [workflow 35685316439](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35685316439), E2E isolato, audit layout e smoke verdi; `/lotti/api/health` sui due domini ha restituito il commit di merge esatto; [CI 35685316482](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35685316482) verde. L'endpoint autenticato con dati reali non è ancora stato collaudato da una sessione utente.
...
- **Priorità operativa aperta:** verificare il ripristino su un caso reale autorizzato e la coerenza dei riferimenti; completare le foto mancanti senza sovrascrivere immagini manuali o inferire identità dal solo nome. La promozione e l'associazione delle immagini da startup devono convergere su identità operative esplicite. Gelati/Prodotti Galatea deve leggere gli acquisti reali, non mostrare un segnaposto.
...
| 2026-09-22 | RST-0508AF-GALATEA-ACQUISTI | 🟢 | [PR #648](https://github.com/ceraldicontabilita/GestionaleCloud/pull/648), merge `bd3eff28bc0412e84071f2390b60e61032bd4832`: eliminato il segnaposto statico; il pannello legge le 22 righe della fattura Lotti `0966541d-e8ff-47f8-9d04-f6650a600abc`, proveniente da ERP `1785230041203`, n. `001852/2` del 14/05/2026, cedente GELINOVA GROUP SRL P.IVA `03762010266`. La 23ª riga ERP è descrittiva, non un articolo. Codice/quantità/prezzo/provenienza mostrati senza inventare allergeni, giacenza o categorie. Corretti commenti che chiamavano Mongo il persistente Supabase. 16 test backend e 89 frontend locali verdi; CI 35685316482, E2E/Produzione 35685316439 verdi; `/lotti/api/health` conferma il commit esatto su entrambi i domini. Non ancora collaudato il pannello autenticato con una sessione utente. L'adattatore compatibile Mongo in memoria rimane debito strutturale distinto. |
| 2026-09-22 | RST-0508AG-GALATEA-SORBETTO | 🟡 | Dai PDF locali del fornitore: brochure Core_Inside Frutta p. 4 e Catalogo 2024 p. 6-7 indicano Easy Limone codice 76001, 1,5 kg di base + 3,5 L d'acqua calda. La nuova formula nel calcolo Gelati esplicita fonte, proporzioni e pesi rapidi; 1 L ≈ 1 kg è solo conversione operativa per la tabella in grammi. I PDF non danno temperatura numerica, tempi né grammi di succo fresco: non inventarli. Le 12 formule Cioccolato già presenti ricevono attribuzione alle pagine 7, 9, 10, 11 della brochure. Non è un acquisto, una giacenza o una produzione registrata. Test/PR/CI/E2E/merge/health in corso. |
...
**Rilascio verificato:** RST-0508AC della PR #645 è pubblicato e accessibile live con `797cd910ae874b4543e2cfc19ab1f74f0adc9014`; il commit è confermato da `/lotti/api/health`. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
