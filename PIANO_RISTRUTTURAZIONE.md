...
| 2026-09-23 | RST-AV3-10-ALLERGENI-MENU | 🟡 | Rimisurato: `allergeni_confermati` e' gia' scartato per scelta (RST-0508AR), ma restavano tre guasti. (1) Il ponte pubblicava `allergeni or allergeni_auto`: una conferma «nessun allergene» (lista vuota) faceva pubblicare gli allergeni automatici. (2) La modifica della ricetta cancellava sempre la conferma umana, anche a ingredienti invariati. (3) `aggiorna-allergeni-ricetta` e `auto-rileva-allergeni-tutte` non riallineavano il Menu. Dati live: 328 ricette tutte `da_confermare`, 0 confermate (nessuna vittima attuale); Menu 359 prodotti, 323 Qromo di cui 108 con allergeni, 36 da Lotti. Il buco di legge sui prodotti Qromo non si chiude col codice: servono dati o esclusioni motivate |
