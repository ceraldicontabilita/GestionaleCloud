...
| 2026-09-22 | RST-0508W-ELIMINAZIONE-RICETTE | 🟡 | PR #639 / merge `accbd03b34d1727c4ca92aa1cde84ded0b36a58a`: il DELETE archivia la copia nel cestino recuperabile e rifiuta l'eliminazione della base con varianti vive. CI 35670946872 e Produzione 35670946877 verdi; `/lotti/api/health` ha servito il merge esatto. Nell'audit Chrome la X non compariva su alcune card per una condizione frontend residua; la sua rimozione è inclusa nella tranche X prima di dichiarare la UI conclusa. La coppia «Babà Napoletano al Rum» / «Babà al rhum» resta candidata esplicita: nessuna variante, produzione o lotto riferiti agli ID; conservare la ricetta con procedimento e archiviare l'altra nel cestino. |
| 2026-09-22 | RST-0508X-DISPONIBILITA-INGREDIENTI-CANONICA | 🟡 | In corso: eliminato nel servizio di disponibilità il confronto per famiglia/somiglianza e riusato il matcher unico dei Lotti. Le forme «olio di arachidi per friggere»/«olio di girasole», «prezzemolo fresco»/«prezzemolo» e «capperi sotto sale»/«capperi» convergono sui nomi canonici; una fattura storica non prova una giacenza, serve un lotto residuo. Rimossa la condizione frontend residua che nascondeva la X sulle card amministrabili. Test comportamentali e build locale verdi; attende PR, CI, produzione e audit Chrome sul commit servito. |
| 2026-09-22 | RST-0508Y-ELIMINAZIONE-PERSISTENTE | 🟡 | In corso: individuata la proiezione archivio che rigenerava card senza record operativo dopo l'eliminazione. La pagina Ricette torna a leggere solo ricette persistite; rimossi rendering e promozione archivio senza chiamanti vivi. Test di refresh con archivio e build locale verdi; attende PR, CI e produzione. |
