...
| 2026-09-21 | RST-0403G-SYNC-PERSONALE | 🟡 | Elenco personale tablet come GET di sola lettura; sincronizzazione HR solo nella POST canonica `/tablet-operatori/sincronizza-hr`. La UI usa la POST all'apertura e al comando esplicito, poi ricarica l'elenco. CI/E2E/Produzione da verificare |
...
**Rilascio verificato:** RST-0403F della PR #612 è pubblicato e accessibile live con `946056d8`; le PR #603-#611 e le precedenti PR #599-#602 restano pubblicate. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
