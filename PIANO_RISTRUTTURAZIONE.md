...
| 2026-09-22 | RST-0508Q-USCITE-LOTTO | 🟡 | Audit dei flussi vivi Recupera/Manda al banco: gli endpoint controllavano il richiamo ma non la scadenza; Recupera usava la chiave di idempotenza `banco_` e poteva riservarla prima della convalida. Servizio comune di prelievo con scadenza verificata, scarico condizionale e retry separato per banco/recupero; modale migrato con ID operazione stabile e ID dipendente della sessione. 41 test backend e build Lotti locali verdi; CI/rilascio da verificare |
...
**Rilascio verificato:** RST-0508P della PR #632 è pubblicato e accessibile live con `1c4f2adf`; le PR #603-#631 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
