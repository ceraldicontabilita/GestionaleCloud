...
- Ultima tranche conclusa: [PR #611](https://github.com/ceraldicontabilita/GestionaleCloud/pull/611), unico percorso health e ping globale Lotti.
- Codice pubblicato e verificato: **`847f15d1f28e5fbbf868e07476eb019209622284`**.
- Prova di produzione: [workflow 35623258002](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35623258002), tutti i job superati, inclusa verifica commit servito e smoke.
...
| 2026-09-21 | RST-0403F-FIRMA-DIPENDENTE | 🟡 | Firma PIN manuale delle temperature riscritta nel componente `firma_dipendente`, che legge direttamente la scheda HR attiva e autorizzata a Lotti; i nuovi record positivi/negativi usano `dipendente_id` HR. Rimosso `firma_operatore`; storico HACCP immutato, anche dove l'ID storico resta da riconciliare. CI/E2E/Produzione da verificare |
...
**Rilascio verificato:** RST-0403E della PR #611 è pubblicato e accessibile live con `847f15d1`; le PR #603-#610 e le precedenti PR #599-#602 restano pubblicate. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
