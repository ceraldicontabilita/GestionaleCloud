...
- Prova di produzione: [workflow 35685316439](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35685316439), E2E isolato, audit layout e smoke verdi; `/lotti/api/health` sui due domini ha restituito il commit di merge esatto; [CI 35685316482](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35685316482) verde. La scheda autenticata ricaricata mostra 22 righe dalla fattura `001852/2`, incluso Easy Limone codice `76001`.
...
| 2026-09-22 | RST-0508AG-GALATEA-SORBETTO | 🟡 | Dai PDF locali del fornitore: brochure Core_Inside Frutta p. 4 e Catalogo 2024 p. 6-7 indicano Easy Limone codice 76001, 1,5 kg di base + 3,5 L d'acqua calda; la fattura live `001852/2` ne conferma l'acquisto (18 kg), non lo stock residuo. La nuova formula nel calcolo Gelati esplicita fonte, proporzioni e pesi rapidi; 1 L ≈ 1 kg è solo conversione operativa per la tabella in grammi. I PDF non danno temperatura numerica, tempi né grammi di succo fresco: non inventarli. Le 12 formule Cioccolato già presenti ricevono attribuzione alle pagine 7, 9, 10, 11 della brochure. Non è una produzione o una ricetta operativa registrata. PR #649 aperta; CI/E2E, merge e health in corso. |
