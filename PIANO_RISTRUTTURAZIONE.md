...
- Ultima tranche conclusa: [PR #618](https://github.com/ceraldicontabilita/GestionaleCloud/pull/618), classificazione unica dei ricettari fornitori.
- Codice pubblicato e verificato: **`475a19a11de400a8141644e5413cd275ac85c73e`**.
- Prova di produzione: [workflow 35633900860](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35633900860), E2E isolato, audit layout e verifica del commit servito; [CI 35633900857](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35633900857) verde. Riallocazione reale di 13 riferimenti SAIMA con backup, secondo dry-run senza spostamenti residui.
...
| 2026-09-21 | RST-0508C-RICETTE-KIOSK | 🟡 | Sostituire card e pagina Dose di oggi con Ricette; dose e moltiplicatore nella scheda ricetta, stessa sessione operatore. Test, CI, E2E e produzione da verificare |
...
**Rilascio verificato:** RST-0508B della PR #618 è pubblicato e accessibile live con `475a19a1`; le PR #603-#617 e le precedenti PR #599-#602 restano pubblicate. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
