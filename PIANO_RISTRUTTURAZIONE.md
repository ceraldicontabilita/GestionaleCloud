...
- Ultima tranche conclusa: [PR #643](https://github.com/ceraldicontabilita/GestionaleCloud/pull/643), archivio documentale separato dalle ricette operative.
- Codice pubblicato e verificato: **`ca0d2397540a834b354a9f5104c86a4071bb2256`**.
- Prova di produzione: [workflow 35680851363](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35680851363), E2E isolato, audit layout e smoke del commit servito tramite `/lotti/api/health`; [CI 35680851409](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35680851409) verde.
...
- **Priorità operativa aperta:** rendere effettivamente ripristinabile il cestino Ricette, mantenere coerenti i riferimenti e completare le foto mancanti senza sovrascrivere immagini manuali o inferire identità dal solo nome.
...
| 2026-09-22 | RST-0508AC-CESTINO-RICETTE | 🟡 | Ripristino amministrativo dalla copia completa nel cestino con lo stesso ID, senza ricreare l'archivio storico né alterare produzioni/lotti; cancellazione manuale e deduplica basi condividono il servizio di archiviazione. Test comportamentali backend e frontend, build locale; PR, CI, E2E, merge e commit servito da verificare prima della chiusura. Nessuna ricetta reale ripristinata automaticamente. |
...
**Rilascio verificato:** RST-0508AA della PR #643 è pubblicato e accessibile live con `ca0d2397540a834b354a9f5104c86a4071bb2256`; il commit è confermato da `/lotti/api/health`. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
