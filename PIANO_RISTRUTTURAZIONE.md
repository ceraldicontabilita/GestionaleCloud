...
- Ultima tranche conclusa: [PR #654](https://github.com/ceraldicontabilita/GestionaleCloud/pull/654), ritiro dei riferimenti a Sheets come archivio operativo.
- Codice pubblicato e verificato: **`4af8831800f748b9e684f789ed7692bf6b478b0d`**.
- Prova di produzione: [CI 35703453008](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35703453008) e [Produzione/E2E 35703453054](https://github.com/ceraldicontabilita/GestionaleCloud/actions/runs/35703453054) verdi; `/lotti/api/health` su `gestionalecloud.onrender.com` e `impresasemplice.online` ha restituito il commit di merge esatto. La revisione UX di tutte le pagine resta aperta in RST-0906.
...
| 2026-09-22 | RST-0906A-NAVIGAZIONE-LOTTI | 🟡 | Primo intervento trasversale della revisione UX: intestazione condivisa Lotti con titolo semantico, icona decorativa non annunciata, navigazione primaria con target tattili da 44 px e stato della pagina attiva esposto alle tecnologie assistive; menu Altro e Importa con stato aperto e target coerenti. Test comportamentali di titolo/menu aggiunti; 92 test Lotti locali verdi. Build, PR, CI/E2E, merge e verifica live ancora da completare. Non chiude RST-0906: ERP, HR, Menu e le pagine Lotti con intestazione propria restano da verificare per micro-tranche. |
...
**Rilascio verificato:** RST-0508AI della PR #651 è pubblicato con `12d5a6c768761cbdcf60b091d11b6a6632952a85`, confermato da `/lotti/api/health`. La correzione puntuale delle due schede HR amministratore/dipendente in produzione è stata verificata con login tablet e `dipendente_id` distinti; i PIN non sono conservati nel piano. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
