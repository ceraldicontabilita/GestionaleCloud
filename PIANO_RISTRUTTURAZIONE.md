...
| RST-0111 | 🟡 | Rimosso l'alias POST `/anomalie/`; creazione anomalie solo su `/anomalie/registra`, usato dalla UI e dai test comportamentali. CI/E2E/Produzione da verificare |
...
| 2026-09-21 | RST-0111-ROTTA-ANOMALIE | 🟡 | Alias POST `/anomalie/` senza chiamanti vivi eliminato; creazione solo su POST `/anomalie/registra`. CI/E2E/Produzione da verificare |
...
**Rilascio verificato:** RST-0403G della PR #613 è pubblicato e accessibile live con `df73e1ff`; le PR #603-#612 e le precedenti PR #599-#602 restano pubblicate. **Non sono concluse** la qualificazione completa della Prima Nota, la gestione PIN centralizzata dalla UI, l'identità unica con mapping HR/Lotti per tutto lo storico, l'unificazione dati/outbox né la fusione HR/Lotti/Menu/frontend. Nessuna di queste attività va dichiarata completata per effetto della sola bonifica.
