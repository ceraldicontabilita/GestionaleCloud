...
| RST-0008 | 🟡 | Inventario strutturale delle quattro interfacce aggiunto: root, entrypoint, mount, toolchain, config, public assets e dipendenze shared sono dichiarati in `frontend_inventory.json` e verificati automaticamente; ERP/HR Vite, Lotti/Menu CRA-CRACO. Attende CI/rilascio; il grafo componenti/lazy interno resta coperto dai test ERP e verrà esteso durante il porting delle sotto-app |
