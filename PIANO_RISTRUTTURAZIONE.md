...
| ID | Stato | Attività e verifica |
|---|---|---|
| RST-0401 | 🟢 | Motore PIN canonico pubblicato con PR #599 / `87efac99`: il router ERP delega identità/ruolo a `app/services/pin_authentication.py`, `utenti_pin.py` non usa più `ADMIN_PIN` in chiaro; CI 35592364449 e Produzione 35592364329 verdi. HR/Lotti/Menu restano da migrare una micro-tranche alla volta |
