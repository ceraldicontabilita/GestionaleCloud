...
export default function BackupView({ onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#2a3329" }}>

      {/* ── Header ── */}
      <div style={{
        background: "linear-gradient(135deg, #3f5a4e, #2a3329)",
        borderBottom: "1px solid #3f5a4e",
        padding: "16px 20px",
        display: "flex", alignItems: "center", gap: 14
      }}>
        <button onClick={onBack} style={{
          background: "#3f5a4e", border: "1px solid #56442d",
          color: "#9aa593", borderRadius: 10, padding: "8px 14px",
          fontWeight: 700, cursor: "pointer", fontSize: 13
        }}>← Indietro</button>
        <div>
          <h1 style={{ color: "#faf7f0", margin: 0, fontSize: 20, fontWeight: 800 }}>
            Backup & Ripristino
          </h1>
          <p style={{ color: "#6b7669", margin: "2px 0 0", fontSize: 12 }}>
            Database: <span style={{ color: "#d4b87f", fontWeight: 700 }}>Gestionale</span>
            {stato?.stato === "ok" && (
              <span style={{ color: "#6b7669" }}> · ultimo backup: {formatData(stato.data)}</span>
            )}
          </p>
        </div>
      </div>
      ...
      <div style={{ padding: "20px", maxWidth: 700, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          border: "1px solid #56442d", padding: "20px",
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <span style={{ color: "#faf7f0", fontWeight: 700, fontSize: 15 }}>
                {lista.length} backup disponibili
              </span>
            </div>
            <p style={{ color: "#6b7669", margin: 0, fontSize: 12 }}>
          ...
          <button
            ...
            style={{
              padding: "12px 22px",
              background: backingUp ? "#56442d" : "linear-gradient(135deg, #a8854f, #8a6f47)",
        ...
        {risultato && (
          <div style={{
            ...
            <p style={{ margin: 0, fontSize: 13, color: "#9aa593" }}>{risultato.messaggio}</p>
            {risultato.success && (
              <p style={{ margin: "6px 0 0", fontSize: 12, color: "#6b7669" }}>
            ...
            <button
              ...
              style={{
                marginTop: 10, padding: "6px 14px", background: "#56442d",
                border: "none", color: "#9aa593", borderRadius: 8,
        ...
        <div style={{ overflowX: "auto" }}>
          ...
          <div style={{
            ...
            {["File", "Dim.", "Data", "Azione"].map(h => (
              <span key={h} style={{
                fontSize: 11, fontWeight: 700, color: "#6b7669", textTransform: "uppercase"
              }}>{h}</span>
            ))}
          </div>

          {loading ? (
            <div style={{ padding: 40, textAlign: "center", color: "#6b7669" }}>
              Caricamento...
            </div>
          ) : lista.length === 0 ? (
            <div style={{ padding: 40, textAlign: "center" }}>
              <p style={{ color: "#6b7669", margin: 0 }}>Nessun backup disponibile</p>
              <p style={{ color: "#56442d", fontSize: 12, margin: "4px 0 0" }}>
            ...
            <div key={b.file}>
              ...
              <div style={{
                ...
                {/* Nome file */}
                <div>
                  <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: "#e6e0d4",
                ...
                {/* Dimensione */}
                <span style={{ fontSize: 13, color: "#6b7669", fontWeight: 600 }}>
                  {b.dimensione}
                </span>

                {/* Data */}
                <span style={{ fontSize: 12, color: "#6b7669" }}>
                  {formatData(b.data)}
                </span>
                ...
                <div style={{ display: "flex", gap: 5, alignItems: "center" }}>
                  ...
                  {ripristino === b.file ? (
                    ...
                    <button
                      ...
                      style={{
                        padding: "6px 12px", background: "#56442d",
                        color: "#9aa593", border: "1px solid #6b7669",
        ...
        <div style={{
          ...
          background: "#3f5a4e", borderRadius: 12,
