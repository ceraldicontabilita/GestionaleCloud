...
test("il pannello mostra solo righe acquistate con la fattura di provenienza", async () => {
  const get = jest.spyOn(axios, "get").mockResolvedValue({ data: {
    ...
    prodotti: [
      { id: "f1:1", descrizione: "SET_CORE VELLUTO 540 KG 2X8", codice_articolo: "71004", quantita: "32", prezzo_unitario: "13.2", fattura_id: "f1", numero_fattura: "001852/2", data_fattura: "14/05/2026" },
