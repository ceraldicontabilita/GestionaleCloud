    ...
    <div style={{ minHeight: "100dvh", background: "var(--bg)" }}>
      ...
      <header className="g-app-header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 }}>
          {amministratore ? (
            <a href="/" data-testid="btn-torna-gestionale" title="Torna al Gestionale" style={{ ...btnHeaderStyle, background: "#fff", color: "#3f5a4e", border: "none", fontWeight: 800, textDecoration: "none", minHeight: 44 }}>
