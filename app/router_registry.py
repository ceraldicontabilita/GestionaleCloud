...
def register_all_routers(app: FastAPI) -> None:
    ...
    # HR (AppDipendenti) e Menu NON sono router del gestionale: sono app
    # portate pari pari, montate come sub-app a /hr e /menu in app/main.py
    # (rotte /hr/api/... e /menu/api/..., login proprio). Vedi CLAUDE.md.
...
def _register_bank(app: FastAPI):
    ...
    # Distinte BPM: importatore applicativo spostato in services/distinte_bpm.py;
...
# Libro Unico: parser/importatore vive in services/libro_unico_parser.py
# ed e' chiamato direttamente dalla pipeline Documenti; nessuna route dedicata.
