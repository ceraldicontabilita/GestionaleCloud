...
# ============== WAREHOUSE ==============
# CRUD legacy rimosso in Fase 0B: nessun chiamante runtime e secondo writer
# del magazzino. L'inventario canonico e' alimentato dai flussi di dominio,
# non da endpoint generici /api/warehouse/*.
