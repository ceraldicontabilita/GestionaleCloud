...
from .bulk import (
    ...
    elimina_fornitori_senza_fatture, ripara_fornitori_sconosciuti,
)
from .base import (
    create_supplier,
...
router.add_api_route("/ripara-sconosciuti", ripara_fornitori_sconosciuti, methods=["POST"])
...
router.add_api_route("", create_supplier, methods=["POST"])
