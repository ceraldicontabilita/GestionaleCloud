...
# Le app portate pari pari (Lotti a /lotti, HR/AppDipendenti a /hr, Menu a
# /menu) vivono FUORI dal prefisso /api/ del gestionale (/lotti/api/...,
# /hr/api/..., /menu/api/...): questo middleware le lascia passare come ogni
# percorso non-/api/ e ciascuna applica la propria autenticazione (PIN di
# Lotti e di AppDipendenti, username/password del Menu).
...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        try:
            ...
            # costare una lettura Drive/Supabase prima di essere respinto localmente.
