...
def register_all_handlers():
    ...
    # --- Fase 4: F24 (Chat 9c) ---
    try:
        from app.hr.services.handlers.f24_handlers import (
    ...
    try:
        from app.hr.services.handlers.cedolino_handlers import (
    ...
    try:
        from app.hr.services.handlers.documento_handlers import (
