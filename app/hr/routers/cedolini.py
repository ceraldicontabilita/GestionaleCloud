...
async def scan_acconti_da_estratto_conto(body: Dict[str, Any] = Body(default={})):
    ...
    from app.hr.services.acconti_auto_linker import scan_and_link_acconti
    from app.hr.database import Database as _DB
...
async def lista_acconti_dipendente(dipendente_id: str, anno: Optional[int] = None):
    ...
    from app.hr.services.acconti_auto_linker import get_pagamenti_dipendente
    from app.hr.database import Database as _DB
