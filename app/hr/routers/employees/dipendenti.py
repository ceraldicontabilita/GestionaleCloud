...
async def lista_duplicati_dipendenti() -> Dict[str, Any]:
    ...
    """
    from app.hr.services.dipendenti_dedupe import trova_duplicati
...
async def merge_duplicato_dipendente(
    ...
    """
    from app.hr.services.dipendenti_dedupe import merge_dipendenti
...
async def auto_merge_duplicati(
    ...
    """
    from app.hr.services.dipendenti_dedupe import auto_merge_tutti
...
async def scan_buste_paga_folders() -> Dict[str, Any]:
    ...
    """
    import os
    from app.hr.utils.busta_paga_parser import scan_all_dipendenti
...
async def get_buste_paga_dipendente(dipendente_id: str) -> Dict[str, Any]:
    ...
    """
    import os
    from app.hr.utils.busta_paga_parser import scan_dipendente_folder
...
async def import_busta_paga_to_dipendente(dipendente_id: str) -> Dict[str, Any]:
    ...
    """
    import os
    from app.hr.utils.busta_paga_parser import get_latest_progressivi
