...
- il modello AI NON ha accesso diretto a Drive/Supabase: interroga i dati solo
...
def is_configured() -> bool:
    ...
    La chiave cifrata in Drive/Supabase viene verificata da ``api_key_configurata``.
    """
    return bool(
