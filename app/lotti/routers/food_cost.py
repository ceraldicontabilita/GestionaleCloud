...
# Il confronto fra fornitori per articolo sta in routers/confronto_fornitori.py
# (fonte: righe delle fatture XML, prezzo per pezzo). I due endpoint che lo
# facevano qui sul dizionario prezzi sono stati tolti: uno solo per funzione.
