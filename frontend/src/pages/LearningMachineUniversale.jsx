...
import api from '../api';
import { Brain, CheckCircle, TrendingUp, Users, CreditCard, Calendar, FileText } from 'lucide-react';
              ...
              <ResultCard
                ...
                insights={[
                  ...
                  getModuleResult('assegni').common_patterns?.length > 0
                    ? `Pattern: ${getModuleResult('assegni').common_patterns.slice(0,2).map(p => p[0]).join(', ')}`
                    : ''
                ].filter(Boolean)}
