...
export default function DizionarioProdotti() {
  ...
  return (
    <PageLayout
      ...
      subtitle="Tutti i prodotti estratti dalle fatture - Modifica il prezzo/kg per calcoli food cost accurati"
    >
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ color: '#6b7280', margin: 0 }}>
            Tutti i prodotti estratti dalle fatture - Modifica il prezzo/kg per calcoli food cost
            accurati
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#1e293b' }}>
                {stats.totale_prodotti?.toLocaleString()}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#10b981' }}>
                {stats.con_prezzo_al_kg?.toLocaleString()}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#f59e0b' }}>
                {(stats.totale_prodotti - stats.con_prezzo_al_kg)?.toLocaleString()}
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div
                style={{
                  fontSize: '24px',
                  fontWeight: 700,
                  color: stats.completezza_percentuale > 50 ? '#10b981' : '#f59e0b',
                }}
              >
        ...
        >
          ...
          <select
            ...
            onChange={e => {
              setFornitoreFilter(e.target.value);
              setOffset(0);
            }}
            style={{
              padding: '8px 12px',
          ...
          >
            <input
              ...
              onChange={e => {
                setSoloSenzaPrezzo(e.target.checked);
                setOffset(0);
              }}
          ...
          >
            {scanResult.error ? (
              ...
              <span style={{ color: '#15803d' }}>
                ...
                Analizzate {scanResult.fatture_analizzate} fatture • Nuovi:{' '}
                {scanResult.prodotti_aggiunti} • Aggiornati: {scanResult.prodotti_aggiornati}
              </span>
            )}
          </div>
        )}
          ...
          <>
                  ...
                  <tbody>
                    {prodotti.map((prod, idx) => (
                      <tr
                        key={prod.id}
                        style={{
                          borderBottom: idx < prodotti.length - 1 ? '1px solid #f1f5f9' : 'none',
                        }}
                      >
                        <td style={{ padding: '12px', maxWidth: '300px' }}>
                          ...
                          <div style={{ fontSize: '10px', color: '#94a3b8', marginTop: '2px' }}>
                            Acquisti: {prod.conteggio_acquisti || 1} •{' '}
                            {prod.ultima_fattura_data || ''}
                          </div>
                        </td>
                        ...
                        >
                          {prod.ultima_quantita?.toLocaleString('it-IT', {
            ...
            >
              <div style={{ fontSize: '13px', color: '#64748b' }}>
                Mostrati {offset + 1}-{Math.min(offset + limit, totale)} di{' '}
              ...
              <div style={{ padding: '24px' }}>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {parseFloat(editForm.quantita)?.toLocaleString('it-IT', {
                        minimumFractionDigits: 2,
                      }) || '-'}
                    </div>
                  </div>
