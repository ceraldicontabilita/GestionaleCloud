            ...
            <div key={p.fattura_id} style={{ background: 'white', borderRadius: 10, padding: '14px 16px', marginBottom: 8, border: '1px solid #fde68a' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 6 }}>
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                  ...
                  <button onClick={()=>{alert('Sospesa: la fattura resta in attesa nella prima nota provvisoria');}} style={{ padding:'6px 12px', background: isSospesa ? '#dc2626' : '#fef2f2', color: isSospesa ? 'white' : '#dc2626', border: isSospesa ? 'none' : '1px solid #fca5a5', borderRadius:6, fontSize:12, cursor:'pointer', fontWeight: isSospesa ? 700 : 400 }}>⏳ Sospesa</button>
