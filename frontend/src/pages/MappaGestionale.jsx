...
const AREAS = [
  ...
  },
  {
    ...
    color: '#5b7a6b',
    group: 'Locale',
    purpose: 'App Menu portata pari pari dentro il gestionale (/menu, login admin proprio): menu pubblico con QR al tavolo, ordini, cassa, cucina, sale, magazzino bar, immagini, backup e sincronizzazione del catalogo da Qromo.',
    pages: ['Menu pubblico', 'Ordini', 'Cassa', 'Cucina', 'Magazzino', 'Sale', 'Prodotti (sync Qromo)', 'QR / WiFi', 'Backup'],
    inputs: ['Catalogo pubblicato su Qromo', 'Ordini dal QR', 'Ordini di cassa', 'Immagini'],
