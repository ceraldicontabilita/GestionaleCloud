...
| 42 | [~] IN REVISIONE | Import documenti — `/documenti/import` | Unico ingresso per PDF/XML/ZIP con classificazione e deduplica. | CORREZIONE E TEST COMPLETATI; ATTENDE PR, DEPLOY E COLLAUDO LIVE |
...
- Test mirati correnti: 39 backend Documenti/Assegni e 18 frontend superati. Suite completa: 1.249 backend superati, 2 saltati e 138 frontend superati; build Vite di produzione riuscita fuori dal repository, senza lasciare asset generati nel ramo. La pagina resta `IN REVISIONE` fino a PR, deploy e collaudo autenticato in sola lettura; nessun documento reale e stato importato durante il collaudo.
