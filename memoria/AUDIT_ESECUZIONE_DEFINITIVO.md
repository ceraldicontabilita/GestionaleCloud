...
| Protocollo contabile | `movimenti_contabili.numero_registrazione` per anno (scelta utente) | `migra_numerazione_protocollo_annuale` (rinumera le scritture esistenti in ordine cronologico, per anno) |
