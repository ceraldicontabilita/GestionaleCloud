...
| `frontend/src/contexts/AnnoContext.jsx` | COMPONENTE_USATO | 52 |
...
| `frontend/src/pages/TracciabilitaHACCP.jsx` | ROUTE_ATTIVA | 2 |
| `frontend/src/pages/TracciabilitaHACCP.test.jsx` | TEST_ONLY | 0 |
