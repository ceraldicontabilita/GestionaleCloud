...
> Totale **1023 endpoint** in **107 prefissi**.
...
| `/api/corrispettivi` | 27 | ✓ | drive_corrispettivi, invoices.corrispettivi |
...
| `/api/fatture-ricevute` | 22 | ✓ | fatture_module.crud, fatture_module.export_selezione, fatture_module.pagamento |
...
| `/api/paypal-statements` | 14 | ✓ | paypal_statements |
...
| `/api/prima-nota` | 77 | ✓ | prima_nota_module, prima_nota_module.attese, prima_nota_module.banca, prima_nota_module.cassa, prima_nota_module.manutenzione, prima_nota_module.salari, prima_nota_module.stats, prima_nota_module.sync |
...
| `/api/verbali-riconciliazione` | 7 | ✓ | verbali_riconciliazione |
