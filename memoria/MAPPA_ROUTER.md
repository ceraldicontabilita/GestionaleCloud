...
> Totale **986 endpoint** in **103 prefissi**.
...
| `/api/config-import` | 2 | ✓ | config_import |
...
| `/api/estratto-conto-movimenti` | 14 | ✓ | bank.estratto_conto |
...
| `/api/prima-nota` | 68 | ✓ | prima_nota_module, prima_nota_module.attese, prima_nota_module.banca, prima_nota_module.cassa, prima_nota_module.manutenzione, prima_nota_module.salari, prima_nota_module.stats, prima_nota_module.sync |
