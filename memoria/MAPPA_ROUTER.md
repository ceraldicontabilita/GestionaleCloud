...
> Totale **990 endpoint** in **103 prefissi**.
...
| `/api/prima-nota` | 70 | ✓ | prima_nota_module, prima_nota_module.attese, prima_nota_module.banca, prima_nota_module.cassa, prima_nota_module.manutenzione, prima_nota_module.salari, prima_nota_module.stats, prima_nota_module.sync |
