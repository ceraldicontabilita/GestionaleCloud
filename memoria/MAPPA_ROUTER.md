...
> Totale **1000 endpoint** in **104 prefissi**.
...
| `/api/prima-nota` | 72 | ✓ | prima_nota_module, prima_nota_module.attese, prima_nota_module.banca, prima_nota_module.cassa, prima_nota_module.manutenzione, prima_nota_module.salari, prima_nota_module.stats, prima_nota_module.sync |
