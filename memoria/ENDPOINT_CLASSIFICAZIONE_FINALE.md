...
| `GET /api/documenti/drive/protocollo/documento/{drive_id}` | documenti | sì | — | — | — | — | tenere | in uso: FE |
| `GET /api/documenti/drive/protocollo/duplicati` | documenti | sì | — | — | — | — | tenere | in uso: FE |
| `POST /api/documenti/drive/protocollo/quarantena` | documenti | sì | — | — | — | — | tenere | in uso: FE |
| `GET /api/documenti/drive/protocollo/search` | documenti | sì | — | — | — | — | tenere | in uso: FE |
| `GET /api/documenti/drive/protocollo/status` | documenti | sì | — | — | — | — | tenere | in uso: FE |
| `POST /api/documenti/drive/protocollo/sync` | documenti | sì | — | — | — | — | tenere | in uso: FE |
...
| `POST /api/documenti/processa-tutti` | documenti | — | — | — | — | sì | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
...
| `POST /api/prima-nota-salari/bonifica-doppioni` | accounting.prima_nota_salari | — | — | — | — | sì | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
...
| `POST /api/prima-nota-salari/deposita-pagamenti-hr` | accounting.prima_nota_salari | — | — | — | — | — | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
...
| `POST /api/prima-nota-salari/import-salari-verificati` | accounting.prima_nota_salari | — | — | — | — | sì | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
...
| `POST /api/prima-nota-salari/sync-hr` | accounting.prima_nota_salari | — | — | — | — | — | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
...
| `GET /api/sumup/rettifica-cassa-corrispettivi` | sumup | — | — | — | — | — | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
| `POST /api/sumup/rettifica-cassa-corrispettivi` | sumup | — | — | — | — | — | verificare | nessun riferimento noto (FE/scheduler/chat/test): verificare prima di deprecare |
