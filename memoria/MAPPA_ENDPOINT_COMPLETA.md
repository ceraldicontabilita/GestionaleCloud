...
| POST | `/api/admin/bonifica-prima-nota-doppioni` | — | admin |
...
| GET | `/api/piano-conti/registra-pregresso/stato` | ✓ | accounting.piano_conti |
...
| POST | `/api/prima-nota-salari/deposita-pagamenti-hr` | — | accounting.prima_nota_salari |
